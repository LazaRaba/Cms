...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220726_wordpresslocal_c600bfd7fdbf0cdc8278_20220726174424_archive.zip';
	const ARCHIVE_SIZE		 = '48349391';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'c600bfd-26174424';
    const SECONDARY_PACKAGE_HASH = 'f4ad4a6-26174424';
	const VERSION			 = '1.4.7';
